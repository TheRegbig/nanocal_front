...
class calibWindow(qt.QDialog):
    def __init__(self, parent=None):
        ...
        self.amplcorBoxInput5 = qt.QLineEdit()
        self.amplcorBoxInput5.setMaximumWidth(short_line_input_width)
        self.amplcorBoxInput5.setFrame(False)
        lout_1.setSpacing(0)
        lout_1.addWidget(qt.QLabel(u"R, \u03A9 = "))
        lout_1.addWidget(self.amplcorBoxInput1)
        lout_1.addStretch()
        lout_2.setSpacing(0)
        lout_2.addWidget(qt.QLabel(u"Ac = "))
        lout_2.addWidget(self.amplcorBoxInput2)
        lout_2.addWidget(qt.QLabel(" + "))
        lout_2.addWidget(self.amplcorBoxInput3)
        lout_2.addWidget(qt.QLabel(u" \u2219 T + "))
        lout_2.addWidget(self.amplcorBoxInput4)
        lout_2.addWidget(qt.QLabel(u" \u2219 "))
        lout_2.addWidget(qt.QLabel("T<sup>2</sup> + "))
        lout_2.addWidget(self.amplcorBoxInput5)
        lout_2.addWidget(qt.QLabel(u" \u2219 "))
        lout_2.addWidget(qt.QLabel("T<sup>3</sup>"))
        lout_2.addStretch()  
    ...
    def update_calib_input_fields(self):     
        ...
        self.amplcorBoxInput1.setText(str(round(self.parent().calibration.rhtr, 10)))
        self.amplcorBoxInput2.setText(str(round(self.parent().calibration.ac0, 10)))
        self.amplcorBoxInput3.setText(str(round(self.parent().calibration.ac1, 10)))
        self.amplcorBoxInput4.setText(str(round(self.parent().calibration.ac2, 10)))
        self.amplcorBoxInput5.setText(str(round(self.parent().calibration.ac3, 10)))
