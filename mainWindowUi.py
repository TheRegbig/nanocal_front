...
class mainWindowUi(qt.QWidget):
    def __init__(self, parent=None):
        ...
        self.sys_on_button.setMinimumWidth(short_button_width)
        self.sys_on_button.setMinimumHeight(short_button_width)
        font.setBold(True)
        self.sys_on_button.setFont(font)
        lout_1.addWidget(self.sys_on_button)
        self.sys_off_button = qt.QPushButton("Off")
        self.sys_off_button.setMinimumWidth(short_button_width)
        self.sys_off_button.setMinimumHeight(short_button_width)
        font.setBold(True)
        ...
        lout_2.addWidget(self.sys_setup_button,0)
