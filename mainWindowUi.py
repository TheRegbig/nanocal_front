...
class mainWindowUi(qt.QWidget):
    def __init__(self, parent=None):
        ...
        systemBox.setFixedSize(lcp_width,120)
        ...
        self.sys_on_button.setFixedSize(short_button_width,40)
        lout_1.addWidget(self.sys_on_button)
        self.sys_off_button = qt.QPushButton("Off")
        self.sys_off_button.setFixedSize(short_button_width,40)
        lout_1.addWidget(self.sys_off_button)
        lout_1.addItem(qt.QSpacerItem(10,10))
        lout_2 = qt.QVBoxLayout()
        lout_1.addLayout(lout_2)
        self.sys_setup_button = qt.QPushButton("Setup")
        self.sys_setup_button.setFixedSize(short_button_width,20)
        lout_2.addWidget(self.sys_setup_button)
        self.sys_help_button = qt.QPushButton("Help")
        self.sys_help_button.setFixedSize(short_button_width,20)
        ...
        pixmap = qt.QPixmap("./res/logo.png").scaledToWidth(0.5*lcp_width)
